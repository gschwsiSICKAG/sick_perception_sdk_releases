...
/**
 * @file Eval029.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval029.
*/
struct SDK_EXPORT Eval029
{

  constexpr static const char* variableName = "Eval029";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval029
  {
    ...
    explicit Eval029(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval029 Eval029)
    : _Eval029(Eval029)
  {}

...
/**
 * @file Eval033.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval033.
*/
struct SDK_EXPORT Eval033
{

  constexpr static const char* variableName = "Eval033";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval033
  {
    ...
    explicit Eval033(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval033 Eval033)
    : _Eval033(Eval033)
  {}

...
/**
 * @file Volume005.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume005.
*/
struct SDK_EXPORT Volume005
{

  constexpr static const char* variableName = "Volume005";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume005
  {
    ...
    explicit Volume005(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume005 Volume005)
    : _Volume005(Volume005)
  {}

  Volume005 _Volume005;
};

}; // struct Get

/**
 * @brief Post Volume005.

...
/**
 * @file Volume017.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume017.
*/
struct SDK_EXPORT Volume017
{

  constexpr static const char* variableName = "Volume017";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume017
  {
    ...
    explicit Volume017(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume017 Volume017)
    : _Volume017(Volume017)
  {}

  Volume017 _Volume017;
};

}; // struct Get

/**
 * @brief Post Volume017.

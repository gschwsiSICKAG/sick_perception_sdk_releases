...
/**
 * @file Volume042.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume042.
*/
struct SDK_EXPORT Volume042
{

  constexpr static const char* variableName = "Volume042";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume042
  {
    ...
    explicit Volume042(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume042 Volume042)
    : _Volume042(Volume042)
  {}

  Volume042 _Volume042;
};

}; // struct Get

/**
 * @brief Post Volume042.

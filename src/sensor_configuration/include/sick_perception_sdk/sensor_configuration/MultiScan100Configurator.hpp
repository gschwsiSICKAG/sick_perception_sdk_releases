...
#include <sick_perception_sdk/sensor_configuration/api/json/multiScan100.g.hpp>
 ...
 * Internally, all parameters are mapped to generated data objects in namespace sick::srt::multiScan100.
 *
 * See SensorConfigurator for a more detailed description of the design principles.
 */
class SDK_EXPORT MultiScan100Configurator : public SensorConfigurator
{
public:
  ...
  public:
    ...
    auto get() const -> srt::multiScan100::FieldEvaluationResult::Get::Response::FieldEvaluationResult;
  ...
  public:
    ...
    auto set(std::chrono::microseconds timeSinceEpoch) const -> srt::multiScan100::LSPsetdatetime::Post::Response::ErrorCode;
  ...
  GetAccess<srt::multiScan100::DeviceStatus::Get::Response::DeviceStatus> const deviceState;

...
/**
 * @file Eval015.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval015.
*/
struct SDK_EXPORT Eval015
{

  constexpr static const char* variableName = "Eval015";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval015
  {
    ...
    explicit Eval015(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval015 Eval015)
    : _Eval015(Eval015)
  {}

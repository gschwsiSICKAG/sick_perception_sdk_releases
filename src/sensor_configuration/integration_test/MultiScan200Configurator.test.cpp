...
TEST_F(MultiScan200ConfiguratorTest, horizontalFieldOfViewCenterAngle_get)
{
  auto const centerAngle = m_configurator.horizontalFieldOfViewCenterAngle.get();
  EXPECT_GE(centerAngle.degrees(), 0.0f);
}

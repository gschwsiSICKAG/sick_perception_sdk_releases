...
/**
 * @file Eval028.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval028.
*/
struct SDK_EXPORT Eval028
{

  constexpr static const char* variableName = "Eval028";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval028
  {
    ...
    explicit Eval028(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval028 Eval028)
    : _Eval028(Eval028)
  {}

...
inline void to_json(nlohmann::ordered_json& j, EncoderDataEthSettings::Get::Response const& obj)
{
  j = nlohmann::ordered_json{
      {"Protocol", obj._Protocol},
      {"IPAddress", obj._IPAddress},
...
inline void from_json(const nlohmann::json& j, EncoderDataEthSettings::Get::Response& obj)
{
  j.at("Protocol").get_to(obj._Protocol);
  j.at("IPAddress").get_to(obj._IPAddress);
  j.at("Port").get_to(obj._Port);
...
inline void to_json(nlohmann::ordered_json& j, EncoderDataEthSettings::Post::Request const& obj)
{
  j = nlohmann::ordered_json{
      {"Protocol", obj._Protocol},
      {"IPAddress", obj._IPAddress},
...
inline void from_json(const nlohmann::json& j, EncoderDataEthSettings::Post::Request& obj)
{
  j.at("Protocol").get_to(obj._Protocol);
  j.at("IPAddress").get_to(obj._IPAddress);
  j.at("Port").get_to(obj._Port);
...
{
  j = nlohmann::ordered_json{
      {"ActualEncPosition1Enable", obj._ActualEncPosition1Enable},
  };
}

inline void from_json(const nlohmann::json& j, ActualEncPosition1Enable::Post::Request& obj)
{
  j.at("ActualEncPosition1Enable").get_to(obj._ActualEncPosition1Enable);
}
...
{
  j = nlohmann::ordered_json{
      {"ActualEncPosition2Enable", obj._ActualEncPosition2Enable},
  };
}

inline void from_json(const nlohmann::json& j, ActualEncPosition2Enable::Post::Request& obj)
{
  j.at("ActualEncPosition2Enable").get_to(obj._ActualEncPosition2Enable);
}

...
/**
 * @file Eval004.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval004.
*/
struct SDK_EXPORT Eval004
{

  constexpr static const char* variableName = "Eval004";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval004
  {
    ...
    explicit Eval004(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval004 Eval004)
    : _Eval004(Eval004)
  {}

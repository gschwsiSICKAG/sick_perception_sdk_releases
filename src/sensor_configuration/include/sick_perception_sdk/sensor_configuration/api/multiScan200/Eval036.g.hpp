...
/**
 * @file Eval036.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval036.
*/
struct SDK_EXPORT Eval036
{

  constexpr static const char* variableName = "Eval036";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval036
  {
    ...
    explicit Eval036(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval036 Eval036)
    : _Eval036(Eval036)
  {}

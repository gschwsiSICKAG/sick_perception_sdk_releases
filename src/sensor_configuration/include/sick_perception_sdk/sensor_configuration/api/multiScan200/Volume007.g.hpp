...
/**
 * @file Volume007.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume007.
*/
struct SDK_EXPORT Volume007
{

  constexpr static const char* variableName = "Volume007";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume007
  {
    ...
    explicit Volume007(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume007 Volume007)
    : _Volume007(Volume007)
  {}

  Volume007 _Volume007;
};

}; // struct Get

/**
 * @brief Post Volume007.

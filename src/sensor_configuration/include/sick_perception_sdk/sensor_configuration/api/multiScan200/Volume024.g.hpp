...
/**
 * @file Volume024.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume024.
*/
struct SDK_EXPORT Volume024
{

  constexpr static const char* variableName = "Volume024";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume024
  {
    ...
    explicit Volume024(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume024 Volume024)
    : _Volume024(Volume024)
  {}

  Volume024 _Volume024;
};

}; // struct Get

/**
 * @brief Post Volume024.

...
/**
 * @file Eval005.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval005.
*/
struct SDK_EXPORT Eval005
{

  constexpr static const char* variableName = "Eval005";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval005
  {
    ...
    explicit Eval005(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval005 Eval005)
    : _Eval005(Eval005)
  {}

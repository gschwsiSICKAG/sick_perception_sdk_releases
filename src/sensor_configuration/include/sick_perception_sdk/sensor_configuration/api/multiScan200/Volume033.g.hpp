...
/**
 * @file Volume033.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume033.
*/
struct SDK_EXPORT Volume033
{

  constexpr static const char* variableName = "Volume033";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume033
  {
    ...
    explicit Volume033(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume033 Volume033)
    : _Volume033(Volume033)
  {}

  Volume033 _Volume033;
};

}; // struct Get

/**
 * @brief Post Volume033.

...
/**
 * @file Eval002.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval002.
*/
struct SDK_EXPORT Eval002
{

  constexpr static const char* variableName = "Eval002";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval002
  {
    ...
    explicit Eval002(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval002 Eval002)
    : _Eval002(Eval002)
  {}

...
/**
 * @file Eval038.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval038.
*/
struct SDK_EXPORT Eval038
{

  constexpr static const char* variableName = "Eval038";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval038
  {
    ...
    explicit Eval038(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval038 Eval038)
    : _Eval038(Eval038)
  {}

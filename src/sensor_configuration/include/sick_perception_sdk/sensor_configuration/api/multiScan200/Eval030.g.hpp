...
/**
 * @file Eval030.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval030.
*/
struct SDK_EXPORT Eval030
{

  constexpr static const char* variableName = "Eval030";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval030
  {
    ...
    explicit Eval030(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval030 Eval030)
    : _Eval030(Eval030)
  {}

...
/**
 * @file Volume043.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume043.
*/
struct SDK_EXPORT Volume043
{

  constexpr static const char* variableName = "Volume043";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume043
  {
    ...
    explicit Volume043(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume043 Volume043)
    : _Volume043(Volume043)
  {}

  Volume043 _Volume043;
};

}; // struct Get

/**
 * @brief Post Volume043.

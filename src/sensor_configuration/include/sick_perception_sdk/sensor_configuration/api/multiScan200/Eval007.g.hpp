...
/**
 * @file Eval007.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval007.
*/
struct SDK_EXPORT Eval007
{

  constexpr static const char* variableName = "Eval007";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval007
  {
    ...
    explicit Eval007(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval007 Eval007)
    : _Eval007(Eval007)
  {}

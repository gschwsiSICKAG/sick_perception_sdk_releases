...
#include <sick_perception_sdk/sensor_configuration/api/multiScan200.g.hpp> // Include all generated payloads for multiScan200
...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    configurator.sensorIPAddressingMode.set(sick::MultiScan200Configurator::IPAddressingMode::StaticIP);
    ...
    std::cout << "IP Mode: " << (modeResponse == sick::MultiScan200Configurator::IPAddressingMode::StaticIP ? "Static" : "DHCP") << '\n';
    ...
    sick::MultiScan200Configurator configuratorNew(httpClientNew, sick::UserLevel::Service, "servicelevel");

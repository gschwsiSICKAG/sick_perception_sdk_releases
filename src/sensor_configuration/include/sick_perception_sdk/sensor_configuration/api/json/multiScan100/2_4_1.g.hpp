...
#include <sick_perception_sdk/sensor_configuration/api/multiScan100/2_4_1.g.hpp>
...
inline void to_json(nlohmann::ordered_json& j, groundFilterEnable::Get::Response const& obj)
{
  j = obj._groundFilterEnable;
}

inline void from_json(const nlohmann::json& j, groundFilterEnable::Get::Response& obj)
{
  j.get_to(obj._groundFilterEnable);
}


inline void to_json(nlohmann::ordered_json& j, groundFilterEnable::Post::Request const& obj)
{
  j = obj._groundFilterEnable;
}

inline void from_json(const nlohmann::json& j, groundFilterEnable::Post::Request& obj)
{
  j.get_to(obj._groundFilterEnable);
}
...
inline void to_json(nlohmann::ordered_json& j, groundFilterType::Get::Response const& obj)
{
  j = obj._groundFilterType;
}

inline void from_json(const nlohmann::json& j, groundFilterType::Get::Response& obj)
{
  j.get_to(obj._groundFilterType);
}
...
{
  j = nlohmann::ordered_json{
      {"EnableDetectionHistory", obj._EnableDetectionHistory},
  };
}

inline void from_json(const nlohmann::json& j, EnableDetectionHistory::Post::Request& obj)
{
  j.at("EnableDetectionHistory").get_to(obj._EnableDetectionHistory);
}
...
inline void to_json(nlohmann::ordered_json& j, bInterlacedMode::Get::Response const& obj)
{
  j = obj._bInterlacedMode;
}

inline void from_json(const nlohmann::json& j, bInterlacedMode::Get::Response& obj)
{
  j.get_to(obj._bInterlacedMode);
}


inline void to_json(nlohmann::ordered_json& j, bInterlacedMode::Post::Request const& obj)
{
  j = obj._bInterlacedMode;
}

inline void from_json(const nlohmann::json& j, bInterlacedMode::Post::Request& obj)
{
  j.get_to(obj._bInterlacedMode);
}
...
inline void to_json(nlohmann::ordered_json& j, LFPmovingAveragingFilter::Get::Response const& obj)
{
  j = nlohmann::ordered_json{
      {"bEnable", obj._bEnable},
      {"uiAveragingDepth", obj._uiAveragingDepth.value()},
  };
}

inline void from_json(const nlohmann::json& j, LFPmovingAveragingFilter::Get::Response& obj)
{
  j.at("bEnable").get_to(obj._bEnable);
  j.at("uiAveragingDepth").get_to(obj._uiAveragingDepth);
}


inline void to_json(nlohmann::ordered_json& j, LFPmovingAveragingFilter::Post::Request const& obj)
{
  j = nlohmann::ordered_json{
      {"bEnable", obj._bEnable},
      {"uiAveragingDepth", obj._uiAveragingDepth.value()},
...
inline void from_json(const nlohmann::json& j, LFPmovingAveragingFilter::Post::Request& obj)
{
  j.at("bEnable").get_to(obj._bEnable);
  j.at("uiAveragingDepth").get_to(obj._uiAveragingDepth);
}
...
inline void to_json(nlohmann::ordered_json& j, ScanDataPreformatting::Get::Response const& obj)
{
  j = obj._ScanDataPreformatting;
}

inline void from_json(const nlohmann::json& j, ScanDataPreformatting::Get::Response& obj)
{
  j.get_to(obj._ScanDataPreformatting);
}


inline void to_json(nlohmann::ordered_json& j, ScanDataPreformatting::Post::Request const& obj)
{
  j = obj._ScanDataPreformatting;
}

inline void from_json(const nlohmann::json& j, ScanDataPreformatting::Post::Request& obj)
{
  j.get_to(obj._ScanDataPreformatting);
}

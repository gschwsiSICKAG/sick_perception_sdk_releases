...
/**
 * @file Volume039.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume039.
*/
struct SDK_EXPORT Volume039
{

  constexpr static const char* variableName = "Volume039";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume039
  {
    ...
    explicit Volume039(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume039 Volume039)
    : _Volume039(Volume039)
  {}

  Volume039 _Volume039;
};

}; // struct Get

/**
 * @brief Post Volume039.

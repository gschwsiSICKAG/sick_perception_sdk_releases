...
/**
 * @file Eval041.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval041.
*/
struct SDK_EXPORT Eval041
{

  constexpr static const char* variableName = "Eval041";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval041
  {
    ...
    explicit Eval041(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval041 Eval041)
    : _Eval041(Eval041)
  {}

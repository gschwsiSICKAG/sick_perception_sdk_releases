...
/**
 * @file Volume012.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume012.
*/
struct SDK_EXPORT Volume012
{

  constexpr static const char* variableName = "Volume012";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume012
  {
    ...
    explicit Volume012(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume012 Volume012)
    : _Volume012(Volume012)
  {}

  Volume012 _Volume012;
};

}; // struct Get

/**
 * @brief Post Volume012.

...
#include <sick_perception_sdk/sensor_configuration/api/multiScan100.g.hpp> // Include all generated payloads for multiScan100
...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    configurator.sensorIPAddressingMode.set(sick::MultiScan100Configurator::IPAddressingMode::StaticIP);
    ...
    std::cout << "IP Mode: " << (modeResponse == sick::MultiScan100Configurator::IPAddressingMode::StaticIP ? "Static" : "DHCP") << '\n';
    ...
    sick::MultiScan100Configurator configuratorNew(httpClientNew, sick::UserLevel::Service, "servicelevel");

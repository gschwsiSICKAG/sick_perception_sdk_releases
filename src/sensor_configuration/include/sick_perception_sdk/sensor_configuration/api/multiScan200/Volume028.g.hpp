...
/**
 * @file Volume028.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume028.
*/
struct SDK_EXPORT Volume028
{

  constexpr static const char* variableName = "Volume028";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume028
  {
    ...
    explicit Volume028(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume028 Volume028)
    : _Volume028(Volume028)
  {}

  Volume028 _Volume028;
};

}; // struct Get

/**
 * @brief Post Volume028.

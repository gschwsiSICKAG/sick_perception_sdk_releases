...
/**
 * @file Volume030.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume030.
*/
struct SDK_EXPORT Volume030
{

  constexpr static const char* variableName = "Volume030";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume030
  {
    ...
    explicit Volume030(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume030 Volume030)
    : _Volume030(Volume030)
  {}

  Volume030 _Volume030;
};

}; // struct Get

/**
 * @brief Post Volume030.

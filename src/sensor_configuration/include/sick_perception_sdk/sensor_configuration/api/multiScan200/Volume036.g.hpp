...
/**
 * @file Volume036.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume036.
*/
struct SDK_EXPORT Volume036
{

  constexpr static const char* variableName = "Volume036";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume036
  {
    ...
    explicit Volume036(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume036 Volume036)
    : _Volume036(Volume036)
  {}

  Volume036 _Volume036;
};

}; // struct Get

/**
 * @brief Post Volume036.

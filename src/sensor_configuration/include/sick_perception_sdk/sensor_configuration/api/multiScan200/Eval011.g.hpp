...
/**
 * @file Eval011.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval011.
*/
struct SDK_EXPORT Eval011
{

  constexpr static const char* variableName = "Eval011";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval011
  {
    ...
    explicit Eval011(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval011 Eval011)
    : _Eval011(Eval011)
  {}

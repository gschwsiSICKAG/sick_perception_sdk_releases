...
/**
 * @file Volume014.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume014.
*/
struct SDK_EXPORT Volume014
{

  constexpr static const char* variableName = "Volume014";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume014
  {
    ...
    explicit Volume014(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume014 Volume014)
    : _Volume014(Volume014)
  {}

  Volume014 _Volume014;
};

}; // struct Get

/**
 * @brief Post Volume014.

...
/**
 * @file Volume037.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume037.
*/
struct SDK_EXPORT Volume037
{

  constexpr static const char* variableName = "Volume037";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume037
  {
    ...
    explicit Volume037(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume037 Volume037)
    : _Volume037(Volume037)
  {}

  Volume037 _Volume037;
};

}; // struct Get

/**
 * @brief Post Volume037.

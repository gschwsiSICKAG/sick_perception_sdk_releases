...
/**
 * @file Eval013.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval013.
*/
struct SDK_EXPORT Eval013
{

  constexpr static const char* variableName = "Eval013";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval013
  {
    ...
    explicit Eval013(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval013 Eval013)
    : _Eval013(Eval013)
  {}

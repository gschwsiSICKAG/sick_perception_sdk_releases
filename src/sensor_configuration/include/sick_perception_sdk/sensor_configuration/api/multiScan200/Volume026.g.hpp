...
/**
 * @file Volume026.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume026.
*/
struct SDK_EXPORT Volume026
{

  constexpr static const char* variableName = "Volume026";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume026
  {
    ...
    explicit Volume026(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume026 Volume026)
    : _Volume026(Volume026)
  {}

  Volume026 _Volume026;
};

}; // struct Get

/**
 * @brief Post Volume026.

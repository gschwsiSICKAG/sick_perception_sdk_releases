...
/**
 * @file Volume021.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume021.
*/
struct SDK_EXPORT Volume021
{

  constexpr static const char* variableName = "Volume021";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume021
  {
    ...
    explicit Volume021(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume021 Volume021)
    : _Volume021(Volume021)
  {}

  Volume021 _Volume021;
};

}; // struct Get

/**
 * @brief Post Volume021.

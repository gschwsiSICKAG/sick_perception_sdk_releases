...
/**
 * @file Eval024.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval024.
*/
struct SDK_EXPORT Eval024
{

  constexpr static const char* variableName = "Eval024";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval024
  {
    ...
    explicit Eval024(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval024 Eval024)
    : _Eval024(Eval024)
  {}

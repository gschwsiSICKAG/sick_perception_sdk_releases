...
/**
 * @file Eval047.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval047.
*/
struct SDK_EXPORT Eval047
{

  constexpr static const char* variableName = "Eval047";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval047
  {
    ...
    explicit Eval047(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval047 Eval047)
    : _Eval047(Eval047)
  {}

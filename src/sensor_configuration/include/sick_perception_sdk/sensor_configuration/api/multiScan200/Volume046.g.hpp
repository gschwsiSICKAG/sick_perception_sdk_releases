...
/**
 * @file Volume046.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume046.
*/
struct SDK_EXPORT Volume046
{

  constexpr static const char* variableName = "Volume046";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume046
  {
    ...
    explicit Volume046(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume046 Volume046)
    : _Volume046(Volume046)
  {}

  Volume046 _Volume046;
};

}; // struct Get

/**
 * @brief Post Volume046.

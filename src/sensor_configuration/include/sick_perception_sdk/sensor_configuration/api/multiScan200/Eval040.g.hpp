...
/**
 * @file Eval040.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval040.
*/
struct SDK_EXPORT Eval040
{

  constexpr static const char* variableName = "Eval040";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval040
  {
    ...
    explicit Eval040(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval040 Eval040)
    : _Eval040(Eval040)
  {}

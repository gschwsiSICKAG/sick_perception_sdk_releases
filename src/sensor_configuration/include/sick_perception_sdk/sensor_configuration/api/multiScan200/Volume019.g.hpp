...
/**
 * @file Volume019.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume019.
*/
struct SDK_EXPORT Volume019
{

  constexpr static const char* variableName = "Volume019";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume019
  {
    ...
    explicit Volume019(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume019 Volume019)
    : _Volume019(Volume019)
  {}

  Volume019 _Volume019;
};

}; // struct Get

/**
 * @brief Post Volume019.

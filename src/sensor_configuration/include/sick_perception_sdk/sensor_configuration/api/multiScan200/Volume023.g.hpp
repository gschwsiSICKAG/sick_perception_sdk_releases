...
/**
 * @file Volume023.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume023.
*/
struct SDK_EXPORT Volume023
{

  constexpr static const char* variableName = "Volume023";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume023
  {
    ...
    explicit Volume023(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume023 Volume023)
    : _Volume023(Volume023)
  {}

  Volume023 _Volume023;
};

}; // struct Get

/**
 * @brief Post Volume023.

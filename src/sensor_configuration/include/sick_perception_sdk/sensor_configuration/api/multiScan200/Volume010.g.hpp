...
/**
 * @file Volume010.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume010.
*/
struct SDK_EXPORT Volume010
{

  constexpr static const char* variableName = "Volume010";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume010
  {
    ...
    explicit Volume010(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume010 Volume010)
    : _Volume010(Volume010)
  {}

  Volume010 _Volume010;
};

}; // struct Get

/**
 * @brief Post Volume010.

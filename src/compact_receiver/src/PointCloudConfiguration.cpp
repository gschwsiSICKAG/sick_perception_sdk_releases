...
auto PointCloudConfiguration::Fields::toString() const -> std::string
{
  ...
  result += "  enableTimeOffsetNanoseconds: " + std::string(enableTimeOffsetNanoseconds ? "true" : "false") + "\n";
  result += "  enableTimeOffsetSeconds: " + std::string(enableTimeOffsetSeconds ? "true" : "false") + "\n";

...
/**
 * @file Volume020.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume020.
*/
struct SDK_EXPORT Volume020
{

  constexpr static const char* variableName = "Volume020";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume020
  {
    ...
    explicit Volume020(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume020 Volume020)
    : _Volume020(Volume020)
  {}

  Volume020 _Volume020;
};

}; // struct Get

/**
 * @brief Post Volume020.

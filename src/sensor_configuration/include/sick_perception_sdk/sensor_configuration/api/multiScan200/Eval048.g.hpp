...
/**
 * @file Eval048.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval048.
*/
struct SDK_EXPORT Eval048
{

  constexpr static const char* variableName = "Eval048";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval048
  {
    ...
    explicit Eval048(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval048 Eval048)
    : _Eval048(Eval048)
  {}

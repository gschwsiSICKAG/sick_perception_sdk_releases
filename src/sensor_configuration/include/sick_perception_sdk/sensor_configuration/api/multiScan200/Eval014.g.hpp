...
/**
 * @file Eval014.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval014.
*/
struct SDK_EXPORT Eval014
{

  constexpr static const char* variableName = "Eval014";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval014
  {
    ...
    explicit Eval014(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval014 Eval014)
    : _Eval014(Eval014)
  {}

...
/**
 * @file Volume002.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume002.
*/
struct SDK_EXPORT Volume002
{

  constexpr static const char* variableName = "Volume002";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume002
  {
    ...
    explicit Volume002(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume002 Volume002)
    : _Volume002(Volume002)
  {}

  Volume002 _Volume002;
};

}; // struct Get

/**
 * @brief Post Volume002.

...
/**
 * @file Volume029.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume029.
*/
struct SDK_EXPORT Volume029
{

  constexpr static const char* variableName = "Volume029";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume029
  {
    ...
    explicit Volume029(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume029 Volume029)
    : _Volume029(Volume029)
  {}

  Volume029 _Volume029;
};

}; // struct Get

/**
 * @brief Post Volume029.

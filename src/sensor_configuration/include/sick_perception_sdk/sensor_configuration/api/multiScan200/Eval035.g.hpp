...
/**
 * @file Eval035.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval035.
*/
struct SDK_EXPORT Eval035
{

  constexpr static const char* variableName = "Eval035";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval035
  {
    ...
    explicit Eval035(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval035 Eval035)
    : _Eval035(Eval035)
  {}

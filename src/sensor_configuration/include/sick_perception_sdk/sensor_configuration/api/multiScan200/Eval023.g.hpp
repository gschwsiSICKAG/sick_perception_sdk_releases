...
/**
 * @file Eval023.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval023.
*/
struct SDK_EXPORT Eval023
{

  constexpr static const char* variableName = "Eval023";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval023
  {
    ...
    explicit Eval023(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval023 Eval023)
    : _Eval023(Eval023)
  {}

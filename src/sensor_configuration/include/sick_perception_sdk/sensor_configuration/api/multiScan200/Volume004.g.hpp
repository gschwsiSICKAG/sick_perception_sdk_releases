...
/**
 * @file Volume004.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume004.
*/
struct SDK_EXPORT Volume004
{

  constexpr static const char* variableName = "Volume004";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume004
  {
    ...
    explicit Volume004(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume004 Volume004)
    : _Volume004(Volume004)
  {}

  Volume004 _Volume004;
};

}; // struct Get

/**
 * @brief Post Volume004.

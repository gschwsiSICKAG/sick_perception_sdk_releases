...
/**
 * @file Eval046.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval046.
*/
struct SDK_EXPORT Eval046
{

  constexpr static const char* variableName = "Eval046";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval046
  {
    ...
    explicit Eval046(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval046 Eval046)
    : _Eval046(Eval046)
  {}

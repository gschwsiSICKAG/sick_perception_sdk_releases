...
void PointCloudToPCDConverter::convertToPCDBinary(MultiEchoPointCloud const& pointCloud, std::ostream& outputStream)
{
...
void PointCloudToPCDConverter::convertToPCDASCII(MultiEchoPointCloud const& pointCloud, std::ostream& outputStream)
{

...
/**
 * @file Volume008.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume008.
*/
struct SDK_EXPORT Volume008
{

  constexpr static const char* variableName = "Volume008";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume008
  {
    ...
    explicit Volume008(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume008 Volume008)
    : _Volume008(Volume008)
  {}

  Volume008 _Volume008;
};

}; // struct Get

/**
 * @brief Post Volume008.

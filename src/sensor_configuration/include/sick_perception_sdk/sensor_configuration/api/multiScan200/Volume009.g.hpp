...
/**
 * @file Volume009.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume009.
*/
struct SDK_EXPORT Volume009
{

  constexpr static const char* variableName = "Volume009";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume009
  {
    ...
    explicit Volume009(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume009 Volume009)
    : _Volume009(Volume009)
  {}

  Volume009 _Volume009;
};

}; // struct Get

/**
 * @brief Post Volume009.

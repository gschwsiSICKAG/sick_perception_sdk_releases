...
/**
 * @file Eval008.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval008.
*/
struct SDK_EXPORT Eval008
{

  constexpr static const char* variableName = "Eval008";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval008
  {
    ...
    explicit Eval008(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval008 Eval008)
    : _Eval008(Eval008)
  {}

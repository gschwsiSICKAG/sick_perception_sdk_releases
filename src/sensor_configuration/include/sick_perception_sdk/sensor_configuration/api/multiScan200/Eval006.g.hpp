...
/**
 * @file Eval006.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval006.
*/
struct SDK_EXPORT Eval006
{

  constexpr static const char* variableName = "Eval006";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval006
  {
    ...
    explicit Eval006(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval006 Eval006)
    : _Eval006(Eval006)
  {}

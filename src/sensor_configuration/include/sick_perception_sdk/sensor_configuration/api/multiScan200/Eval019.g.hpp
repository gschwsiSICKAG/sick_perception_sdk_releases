...
/**
 * @file Eval019.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval019.
*/
struct SDK_EXPORT Eval019
{

  constexpr static const char* variableName = "Eval019";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval019
  {
    ...
    explicit Eval019(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval019 Eval019)
    : _Eval019(Eval019)
  {}

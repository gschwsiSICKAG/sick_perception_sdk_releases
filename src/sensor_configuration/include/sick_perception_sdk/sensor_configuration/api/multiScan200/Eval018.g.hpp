...
/**
 * @file Eval018.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval018.
*/
struct SDK_EXPORT Eval018
{

  constexpr static const char* variableName = "Eval018";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval018
  {
    ...
    explicit Eval018(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval018 Eval018)
    : _Eval018(Eval018)
  {}

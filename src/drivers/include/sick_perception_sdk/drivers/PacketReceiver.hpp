...
#include <sick_perception_sdk/drivers/socket/Socket.hpp>
...
public:
  PacketReceiver(
    ...
    std::string streamName                     = "PacketReceiver"
  )
  ...
  auto operator=(PacketReceiver const&) -> PacketReceiver& = delete;
  PacketReceiver(PacketReceiver&&)                         = delete;
  auto operator=(PacketReceiver&&) -> PacketReceiver&      = delete;

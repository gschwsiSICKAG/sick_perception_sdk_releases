...
/**
 * @file Volume003.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume003.
*/
struct SDK_EXPORT Volume003
{

  constexpr static const char* variableName = "Volume003";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume003
  {
    ...
    explicit Volume003(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume003 Volume003)
    : _Volume003(Volume003)
  {}

  Volume003 _Volume003;
};

}; // struct Get

/**
 * @brief Post Volume003.

...
/**
 * @file Volume011.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume011.
*/
struct SDK_EXPORT Volume011
{

  constexpr static const char* variableName = "Volume011";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume011
  {
    ...
    explicit Volume011(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume011 Volume011)
    : _Volume011(Volume011)
  {}

  Volume011 _Volume011;
};

}; // struct Get

/**
 * @brief Post Volume011.

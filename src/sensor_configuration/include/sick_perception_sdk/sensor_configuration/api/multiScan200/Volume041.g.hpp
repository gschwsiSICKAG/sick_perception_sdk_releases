...
/**
 * @file Volume041.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume041.
*/
struct SDK_EXPORT Volume041
{

  constexpr static const char* variableName = "Volume041";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume041
  {
    ...
    explicit Volume041(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume041 Volume041)
    : _Volume041(Volume041)
  {}

  Volume041 _Volume041;
};

}; // struct Get

/**
 * @brief Post Volume041.

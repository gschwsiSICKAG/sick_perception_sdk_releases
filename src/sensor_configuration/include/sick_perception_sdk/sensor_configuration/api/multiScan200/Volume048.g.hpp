...
/**
 * @file Volume048.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume048.
*/
struct SDK_EXPORT Volume048
{

  constexpr static const char* variableName = "Volume048";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume048
  {
    ...
    explicit Volume048(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume048 Volume048)
    : _Volume048(Volume048)
  {}

  Volume048 _Volume048;
};

}; // struct Get

/**
 * @brief Post Volume048.

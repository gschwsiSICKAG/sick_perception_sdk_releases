...
public:
  ...
  public:
    ...
    auto set(std::chrono::microseconds timeSinceEpoch) const -> srt::LRS4000::mSetDateTime::Post::Response::ErrorCode;
  ...
  LRS4000Configurator(LRS4000Configurator const&)                    = delete;
  auto operator=(LRS4000Configurator const&) -> LRS4000Configurator& = delete;
  LRS4000Configurator(LRS4000Configurator&&)                         = delete;
  auto operator=(LRS4000Configurator&&) -> LRS4000Configurator&      = delete;

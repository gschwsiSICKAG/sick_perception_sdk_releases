...
/**
 * @file Eval010.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval010.
*/
struct SDK_EXPORT Eval010
{

  constexpr static const char* variableName = "Eval010";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval010
  {
    ...
    explicit Eval010(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval010 Eval010)
    : _Eval010(Eval010)
  {}

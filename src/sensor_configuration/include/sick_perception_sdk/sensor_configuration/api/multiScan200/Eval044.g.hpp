...
/**
 * @file Eval044.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval044.
*/
struct SDK_EXPORT Eval044
{

  constexpr static const char* variableName = "Eval044";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval044
  {
    ...
    explicit Eval044(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval044 Eval044)
    : _Eval044(Eval044)
  {}

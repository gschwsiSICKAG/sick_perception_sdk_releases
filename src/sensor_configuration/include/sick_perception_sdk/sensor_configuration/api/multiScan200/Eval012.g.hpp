...
/**
 * @file Eval012.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval012.
*/
struct SDK_EXPORT Eval012
{

  constexpr static const char* variableName = "Eval012";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval012
  {
    ...
    explicit Eval012(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval012 Eval012)
    : _Eval012(Eval012)
  {}

...
/**
 * @file Volume015.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume015.
*/
struct SDK_EXPORT Volume015
{

  constexpr static const char* variableName = "Volume015";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume015
  {
    ...
    explicit Volume015(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume015 Volume015)
    : _Volume015(Volume015)
  {}

  Volume015 _Volume015;
};

}; // struct Get

/**
 * @brief Post Volume015.

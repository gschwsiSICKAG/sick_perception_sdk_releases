...
/**
 * @file Eval021.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval021.
*/
struct SDK_EXPORT Eval021
{

  constexpr static const char* variableName = "Eval021";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval021
  {
    ...
    explicit Eval021(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval021 Eval021)
    : _Eval021(Eval021)
  {}

...
/**
 * @file Volume022.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume022.
*/
struct SDK_EXPORT Volume022
{

  constexpr static const char* variableName = "Volume022";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume022
  {
    ...
    explicit Volume022(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume022 Volume022)
    : _Volume022(Volume022)
  {}

  Volume022 _Volume022;
};

}; // struct Get

/**
 * @brief Post Volume022.

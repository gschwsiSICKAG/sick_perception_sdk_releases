...
/**
 * @file Eval043.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval043.
*/
struct SDK_EXPORT Eval043
{

  constexpr static const char* variableName = "Eval043";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval043
  {
    ...
    explicit Eval043(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval043 Eval043)
    : _Eval043(Eval043)
  {}

...
/**
 * @file Eval034.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval034.
*/
struct SDK_EXPORT Eval034
{

  constexpr static const char* variableName = "Eval034";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval034
  {
    ...
    explicit Eval034(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval034 Eval034)
    : _Eval034(Eval034)
  {}

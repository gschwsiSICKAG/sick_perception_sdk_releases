...
struct LFPangleRangeFilter
{
  ...
  struct Get
  {
    struct Response
    {
      ...
      explicit Response(bool bEnable, NumericRange<std::int32_t, -1800000, 1800000, -900000> fThetaStart, NumericRange<std::int32_t, -1800000, 1800000, 900000> fThetaStop, NumericRange<std::int32_t, -900000, 900000, -900000> fPhiStart, NumericRange<std::int32_t, -900000, 900000, 900000> fPhiStop, NumericRange<std::uint16_t, 1, 20, 1> uiBeamIncrement)
      ...
      bool _bEnable;
      NumericRange<std::int32_t, -1800000, 1800000, -900000> _fThetaStart;
      NumericRange<std::int32_t, -1800000, 1800000, 900000> _fThetaStop;
 ...
 This function requires at least user level: Authorized Client.
  ...
  struct Post
  {
    struct Request
    {
      ...
      explicit Request(bool bEnable, NumericRange<std::int32_t, -1800000, 1800000, -900000> fThetaStart, NumericRange<std::int32_t, -1800000, 1800000, 900000> fThetaStop, NumericRange<std::int32_t, -900000, 900000, -900000> fPhiStart, NumericRange<std::int32_t, -900000, 900000, 900000> fPhiStop, NumericRange<std::uint16_t, 1, 20, 1> uiBeamIncrement)
        : _bEnable(bEnable), _fThetaStart(std::move(fThetaStart)), _fThetaStop(std::move(fThetaStop)), _fPhiStart(std::move(fPhiStart)), _fPhiStop(std::move(fPhiStop)), _uiBeamIncrement(std::move(uiBeamIncrement))
      {}

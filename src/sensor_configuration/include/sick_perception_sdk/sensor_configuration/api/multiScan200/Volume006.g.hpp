...
/**
 * @file Volume006.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume006.
*/
struct SDK_EXPORT Volume006
{

  constexpr static const char* variableName = "Volume006";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume006
  {
    ...
    explicit Volume006(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume006 Volume006)
    : _Volume006(Volume006)
  {}

  Volume006 _Volume006;
};

}; // struct Get

/**
 * @brief Post Volume006.

...
/**
 * @file setDateTimeUTC.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /setDateTimeUTC.
*/
struct SDK_EXPORT setDateTimeUTC
{

  constexpr static const char* methodName = "setDateTimeUTC";
  constexpr static const bool isSopasMethod = true;

  /**
   * @brief Sets the current time of device in UTC (years, months, days, hours, minutes, seconds, microseconds). Does only work if NTP-Client and PTP is not active.

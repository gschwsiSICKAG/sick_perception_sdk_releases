...
/**
 * @file Eval020.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval020.
*/
struct SDK_EXPORT Eval020
{

  constexpr static const char* variableName = "Eval020";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval020
  {
    ...
    explicit Eval020(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval020 Eval020)
    : _Eval020(Eval020)
  {}

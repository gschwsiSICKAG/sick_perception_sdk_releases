  ...
  struct Get
  {
    struct Response
    {
      struct PortConfigurationItem
      {
        ...
        explicit PortConfigurationItem(PortType PortType, std::string Name, InputSettings InputSettings, OutputSettings OutputSettings, EncoderPortType EncoderPortType, std::uint16_t Reserved8, std::uint16_t Reserved9, std::uint16_t Reserved10)

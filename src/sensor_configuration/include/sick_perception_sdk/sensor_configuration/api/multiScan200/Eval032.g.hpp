...
/**
 * @file Eval032.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval032.
*/
struct SDK_EXPORT Eval032
{

  constexpr static const char* variableName = "Eval032";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval032
  {
    ...
    explicit Eval032(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval032 Eval032)
    : _Eval032(Eval032)
  {}

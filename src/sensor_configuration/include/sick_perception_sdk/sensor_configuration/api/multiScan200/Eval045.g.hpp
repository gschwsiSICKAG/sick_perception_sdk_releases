...
/**
 * @file Eval045.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval045.
*/
struct SDK_EXPORT Eval045
{

  constexpr static const char* variableName = "Eval045";
...
struct SDK_EXPORT Response
{
  ...
  explicit Response(Eval045 Eval045)
    : _Eval045(Eval045)
  {}

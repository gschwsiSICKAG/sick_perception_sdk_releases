...
/**
 * @file Eval003.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval003.
*/
struct SDK_EXPORT Eval003
{

  constexpr static const char* variableName = "Eval003";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval003
  {
    ...
    explicit Eval003(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval003 Eval003)
    : _Eval003(Eval003)
  {}

...
/**
 * @file Eval017.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval017.
*/
struct SDK_EXPORT Eval017
{

  constexpr static const char* variableName = "Eval017";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval017
  {
    ...
    explicit Eval017(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval017 Eval017)
    : _Eval017(Eval017)
  {}

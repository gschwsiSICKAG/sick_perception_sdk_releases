...
public:
  ...
  struct HorizontalAngleRangeFilterSettings
  {
    Angle start;
    Angle end;
    NumericRange<std::uint16_t, 1, 50, 1> indexIncrement;
  };
  ...
  struct VerticalAngleRangeFilterSettings
  {
    Angle outerStart;
    Angle outerEnd;
    NumericRange<std::uint16_t, 1, 50, 2> outerIndexIncrement;
    Angle innerStart;
    Angle innerEnd;
    NumericRange<std::uint16_t, 1, 50, 1> innerIndexIncrement;
  };

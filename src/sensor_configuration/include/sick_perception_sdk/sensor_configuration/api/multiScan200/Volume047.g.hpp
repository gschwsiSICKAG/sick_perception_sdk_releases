...
/**
 * @file Volume047.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume047.
*/
struct SDK_EXPORT Volume047
{

  constexpr static const char* variableName = "Volume047";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume047
  {
    ...
    explicit Volume047(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume047 Volume047)
    : _Volume047(Volume047)
  {}

  Volume047 _Volume047;
};

}; // struct Get

/**
 * @brief Post Volume047.

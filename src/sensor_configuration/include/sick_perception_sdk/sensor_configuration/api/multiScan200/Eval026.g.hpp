...
/**
 * @file Eval026.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval026.
*/
struct SDK_EXPORT Eval026
{

  constexpr static const char* variableName = "Eval026";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval026
  {
    ...
    explicit Eval026(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval026 Eval026)
    : _Eval026(Eval026)
  {}

...
/**
 * @file Volume025.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume025.
*/
struct SDK_EXPORT Volume025
{

  constexpr static const char* variableName = "Volume025";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume025
  {
    ...
    explicit Volume025(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume025 Volume025)
    : _Volume025(Volume025)
  {}

  Volume025 _Volume025;
};

}; // struct Get

/**
 * @brief Post Volume025.

...
/**
 * @file Eval009.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval009.
*/
struct SDK_EXPORT Eval009
{

  constexpr static const char* variableName = "Eval009";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval009
  {
    ...
    explicit Eval009(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval009 Eval009)
    : _Eval009(Eval009)
  {}

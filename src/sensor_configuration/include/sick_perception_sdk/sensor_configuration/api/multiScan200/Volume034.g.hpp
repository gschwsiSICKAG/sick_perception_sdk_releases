...
/**
 * @file Volume034.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume034.
*/
struct SDK_EXPORT Volume034
{

  constexpr static const char* variableName = "Volume034";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume034
  {
    ...
    explicit Volume034(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume034 Volume034)
    : _Volume034(Volume034)
  {}

  Volume034 _Volume034;
};

}; // struct Get

/**
 * @brief Post Volume034.

...
/**
 * @file Eval027.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval027.
*/
struct SDK_EXPORT Eval027
{

  constexpr static const char* variableName = "Eval027";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval027
  {
    ...
    explicit Eval027(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval027 Eval027)
    : _Eval027(Eval027)
  {}

...
/**
 * @file Volume040.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume040.
*/
struct SDK_EXPORT Volume040
{

  constexpr static const char* variableName = "Volume040";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume040
  {
    ...
    explicit Volume040(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume040 Volume040)
    : _Volume040(Volume040)
  {}

  Volume040 _Volume040;
};

}; // struct Get

/**
 * @brief Post Volume040.

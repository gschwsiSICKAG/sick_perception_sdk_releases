...
/**
 * @file Volume031.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume031.
*/
struct SDK_EXPORT Volume031
{

  constexpr static const char* variableName = "Volume031";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume031
  {
    ...
    explicit Volume031(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume031 Volume031)
    : _Volume031(Volume031)
  {}

  Volume031 _Volume031;
};

}; // struct Get

/**
 * @brief Post Volume031.

...
void printEvaluationGroupStates(sick::MultiScan100Configurator& configurator)
{
...
void printEvaluationFieldsStates(std::vector<int>& evaluationIDs, sick::MultiScan100Configurator& configurator)
{
...
void scaleEvaluationContours(std::vector<int>& evaluationIDs, sick::MultiScan100Configurator& configurator)
{
...
int main(int argc, char* argv[])
{
  ...
  using FieldEvalResult = sick::srt::multiScan100::FieldEvaluationResult::Get::Response::FieldEvaluationResult;
  using EvalState       = sick::srt::multiScan100::FieldEvaluationResult::Get::Response::FieldEvaluationResult::EvaluationResultListItem::State;

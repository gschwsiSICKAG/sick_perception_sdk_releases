...
struct SDK_EXPORT Response
{
  ...
  explicit Response(bool bEnable, NumericRange<0, 300000, 0> ulDistMin, NumericRange<0, 300000, 200000> ulDistMax)
    : _bEnable(bEnable), _ulDistMin(std::move(ulDistMin)), _ulDistMax(std::move(ulDistMax))
  {}

  bool _bEnable;
  NumericRange<0, 300000, 0> _ulDistMin;
  NumericRange<0, 300000, 200000> _ulDistMax;
};
...
struct SDK_EXPORT Request
{
  ...
  explicit Request(bool bEnable, NumericRange<0, 300000, 0> ulDistMin, NumericRange<0, 300000, 200000> ulDistMax)
    : _bEnable(bEnable), _ulDistMin(std::move(ulDistMin)), _ulDistMax(std::move(ulDistMax))
  {}

...
/**
 * @file Volume032.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume032.
*/
struct SDK_EXPORT Volume032
{

  constexpr static const char* variableName = "Volume032";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume032
  {
    ...
    explicit Volume032(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume032 Volume032)
    : _Volume032(Volume032)
  {}

  Volume032 _Volume032;
};

}; // struct Get

/**
 * @brief Post Volume032.

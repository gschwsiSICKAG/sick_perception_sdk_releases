...
{
  std::cout << "Received encoder data with timestamp: \t" << compactEncoder.header.transmitTimestamp << " us\n";
}
...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    configurator.enableEncoderStreaming("192.168.0.100", 7504); // Enter your computer's IP address
  }
  ...
  driver.setOnNewEncoderData(onNewEncoderData, 7504);
  driver.run();

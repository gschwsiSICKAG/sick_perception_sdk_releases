...
#include <sick_perception_sdk/sensor_configuration/api/LRS4000.g.hpp> // Include all generated payloads for LRS4000
...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    configurator.sensorIPAddressingMode.set(sick::LRS4000Configurator::IPAddressingMode::StaticIP);
    ...
    std::cout << "IP Mode: " << (modeResponse == sick::LRS4000Configurator::IPAddressingMode::StaticIP ? "Static" : "DHCP") << '\n';
    ...
    sick::LRS4000Configurator configuratorNew(httpClientNew, sick::UserLevel::Service, "servicelevel");

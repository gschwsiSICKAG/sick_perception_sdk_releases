...
/**
 * @file Volume027.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume027.
*/
struct SDK_EXPORT Volume027
{

  constexpr static const char* variableName = "Volume027";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume027
  {
    ...
    explicit Volume027(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume027 Volume027)
    : _Volume027(Volume027)
  {}

  Volume027 _Volume027;
};

}; // struct Get

/**
 * @brief Post Volume027.

...
/**
 * @file Volume044.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume044.
*/
struct SDK_EXPORT Volume044
{

  constexpr static const char* variableName = "Volume044";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume044
  {
    ...
    explicit Volume044(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume044 Volume044)
    : _Volume044(Volume044)
  {}

  Volume044 _Volume044;
};

}; // struct Get

/**
 * @brief Post Volume044.

...
/**
 * @file Eval042.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval042.
*/
struct SDK_EXPORT Eval042
{

  constexpr static const char* variableName = "Eval042";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval042
  {
    ...
    explicit Eval042(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval042 Eval042)
    : _Eval042(Eval042)
  {}

...
/**
 * @file Eval016.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval016.
*/
struct SDK_EXPORT Eval016
{

  constexpr static const char* variableName = "Eval016";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval016
  {
    ...
    explicit Eval016(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval016 Eval016)
    : _Eval016(Eval016)
  {}

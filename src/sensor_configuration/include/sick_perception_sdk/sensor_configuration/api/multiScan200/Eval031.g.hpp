...
/**
 * @file Eval031.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval031.
*/
struct SDK_EXPORT Eval031
{

  constexpr static const char* variableName = "Eval031";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval031
  {
    ...
    explicit Eval031(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval031 Eval031)
    : _Eval031(Eval031)
  {}

...
/**
 * @file Eval037.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval037.
*/
struct SDK_EXPORT Eval037
{

  constexpr static const char* variableName = "Eval037";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval037
  {
    ...
    explicit Eval037(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval037 Eval037)
    : _Eval037(Eval037)
  {}

...
/**
 * @file Eval022.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval022.
*/
struct SDK_EXPORT Eval022
{

  constexpr static const char* variableName = "Eval022";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval022
  {
    ...
    explicit Eval022(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval022 Eval022)
    : _Eval022(Eval022)
  {}

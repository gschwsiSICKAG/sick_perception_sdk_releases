...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    std::cout << "OpHours: \t" << configurator.readVariable<sick::srt::multiScan100::OpHours>()._OpHours << '\n';

    std::cout << "Setting echo filter with convenience function...\n";
    configurator.echoFilter.set(sick::MultiScan100Configurator::EchoFilterSetting::LastEcho);

...
#include <sick_perception_sdk/sensor_configuration/api/multiScan200/0_9_0.g.hpp>
...
inline void to_json(nlohmann::ordered_json& j, horizontalFieldOfViewCenterAngle::Get::Response const& obj)
{
  j = obj._horizontalFieldOfViewCenterAngle.value();
}

inline void from_json(const nlohmann::json& j, horizontalFieldOfViewCenterAngle::Get::Response& obj)
{
  j.get_to(obj._horizontalFieldOfViewCenterAngle);
}


inline void to_json(nlohmann::ordered_json& j, horizontalFieldOfViewCenterAngle::Post::Request const& obj)
{
  j = obj._horizontalFieldOfViewCenterAngle.value();
}

inline void from_json(const nlohmann::json& j, horizontalFieldOfViewCenterAngle::Post::Request& obj)
{
  j.get_to(obj._horizontalFieldOfViewCenterAngle);
}
...
inline void to_json(nlohmann::ordered_json& j, setDateTimeUTC::Post::Request::DateTime const& obj)
{
  j = nlohmann::ordered_json{
      {"uiYear", obj._uiYear.value()},
      {"usiMonth", obj._usiMonth.value()},
...
inline void from_json(const nlohmann::json& j, setDateTimeUTC::Post::Request::DateTime& obj)
{
  j.at("uiYear").get_to(obj._uiYear);
  j.at("usiMonth").get_to(obj._usiMonth);
  j.at("usiDay").get_to(obj._usiDay);
...
inline void to_json(nlohmann::ordered_json& j, setDateTimeUTC::Post::Request const& obj)
{
  j = nlohmann::ordered_json{
      {"DateTime", obj._DateTime},
  };
...
inline void from_json(const nlohmann::json& j, setDateTimeUTC::Post::Request& obj)
{
  j.at("DateTime").get_to(obj._DateTime);
}


inline void to_json(nlohmann::ordered_json& j, setDateTimeUTC::Post::Response const& obj)
{
  j = nlohmann::ordered_json{
      {"ErrorCode", obj._ErrorCode},
  };
...
inline void from_json(const nlohmann::json& j, setDateTimeUTC::Post::Response& obj)
{
  j.at("ErrorCode").get_to(obj._ErrorCode);
}

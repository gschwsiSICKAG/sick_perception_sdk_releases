...
/**
 * @file Eval039.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval039.
*/
struct SDK_EXPORT Eval039
{

  constexpr static const char* variableName = "Eval039";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval039
  {
    ...
    explicit Eval039(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval039 Eval039)
    : _Eval039(Eval039)
  {}

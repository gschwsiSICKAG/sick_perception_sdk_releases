...
{
  api::rest::LFPparticle::Post::Request const request {true, static_cast<int>(threshold.millimeters())};
...
using C       = picoScan150::v2_2_1::Configurator;
namespace api = picoScan150::v2_2_1::api;

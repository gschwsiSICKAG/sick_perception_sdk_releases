...
/**
 * @file Volume016.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume016.
*/
struct SDK_EXPORT Volume016
{

  constexpr static const char* variableName = "Volume016";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume016
  {
    ...
    explicit Volume016(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume016 Volume016)
    : _Volume016(Volume016)
  {}

  Volume016 _Volume016;
};

}; // struct Get

/**
 * @brief Post Volume016.

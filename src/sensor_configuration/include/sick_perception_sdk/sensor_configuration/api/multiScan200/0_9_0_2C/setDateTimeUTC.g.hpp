...
struct setDateTimeUTC
{
  ...
  /**
   * @brief Preferred method to sets the current time of device in UTC (years, months, days, hours, minutes, seconds, microseconds). Does only work if NTP-Client and PTP is not active.

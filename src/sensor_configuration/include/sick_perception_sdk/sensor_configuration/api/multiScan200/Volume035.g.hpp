...
/**
 * @file Volume035.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume035.
*/
struct SDK_EXPORT Volume035
{

  constexpr static const char* variableName = "Volume035";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume035
  {
    ...
    explicit Volume035(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume035 Volume035)
    : _Volume035(Volume035)
  {}

  Volume035 _Volume035;
};

}; // struct Get

/**
 * @brief Post Volume035.

...
#include <sick_perception_sdk/sensor_configuration/api/json/picoScan100.g.hpp>
 ...
 * Internally, all parameters are mapped to generated data objects in namespace sick::srt::picoScan100.
 *
 * See SensorConfigurator for a more detailed description of the design principles.
 */
class SDK_EXPORT PicoScan100Configurator : public SensorConfigurator
{
public:
...
public:
  ...
  public:
    ...
    auto set(std::chrono::microseconds timeSinceEpoch) const -> srt::picoScan100::LSPsetdatetime::Post::Response::ErrorCode;
  ...
  public:
    ...
    auto get() const -> srt::picoScan100::FieldEvaluationResult::Get::Response::FieldEvaluationResult;
...
public:
  ...
  GetAccess<srt::picoScan100::DeviceStatus::Get::Response::DeviceStatus> const deviceState;

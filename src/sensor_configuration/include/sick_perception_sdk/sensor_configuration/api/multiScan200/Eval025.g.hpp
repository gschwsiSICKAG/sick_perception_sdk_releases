...
/**
 * @file Eval025.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Eval025.
*/
struct SDK_EXPORT Eval025
{

  constexpr static const char* variableName = "Eval025";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Eval025
  {
    ...
    explicit Eval025(int Version, Source Source, std::string Name, int ID, std::vector<EvaluationParamsMaskBasedItem> EvaluationParamsMaskBased, std::vector<EvaluationParamsSegmentationBasedItem> EvaluationParamsSegmentationBased, std::vector<EvaluationParamsCommonItem> EvaluationParamsCommon, std::vector<EvaluationParamsExitSizeItem> EvaluationParamsExitSize, std::vector<int> VolumeList)
  ...
  explicit Response(Eval025 Eval025)
    : _Eval025(Eval025)
  {}

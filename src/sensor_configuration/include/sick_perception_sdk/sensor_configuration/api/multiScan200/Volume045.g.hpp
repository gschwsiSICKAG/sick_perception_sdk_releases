...
/**
 * @file Volume045.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume045.
*/
struct SDK_EXPORT Volume045
{

  constexpr static const char* variableName = "Volume045";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume045
  {
    ...
    explicit Volume045(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume045 Volume045)
    : _Volume045(Volume045)
  {}

  Volume045 _Volume045;
};

}; // struct Get

/**
 * @brief Post Volume045.

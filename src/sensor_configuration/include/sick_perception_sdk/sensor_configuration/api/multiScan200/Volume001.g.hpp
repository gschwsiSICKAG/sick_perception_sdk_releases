...
/**
 * @file Volume001.g.hpp Sensor REST API payload definitions.
...
/**
 * @brief Payloads for endpoint /Volume001.
*/
struct SDK_EXPORT Volume001
{

  constexpr static const char* variableName = "Volume001";
...
struct SDK_EXPORT Response
{
  struct SDK_EXPORT Volume001
  {
    ...
    explicit Volume001(int Version, std::string Name, int ID, std::vector<ExtrudedPolygonListItem> ExtrudedPolygonList)
  ...
  explicit Response(Volume001 Volume001)
    : _Volume001(Volume001)
  {}

  Volume001 _Volume001;
};

}; // struct Get

/**
 * @brief Post Volume001.
